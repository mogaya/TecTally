...
header('Content-Disposition: attachment;filename=ict_employees.csv');
...
// Query the database for ICT employees
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    fputcsv($output, ['No employees found in the ICT Department']);
}
