...
header('Content-Disposition: attachment;filename=networking_assets.csv');
...
// Query the database for Networking assets
$query = "SELECT * FROM assets WHERE ast_category = 'Networking'";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    fputcsv($output, ['No assets found in the Networking category']);
}
