...
header('Content-Disposition: attachment;filename=human_resource_employees.csv');
...
// Query the database for Human Resource employees
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    fputcsv($output, ['No employees found in the Human Resource Department']);
}
