...
header('Content-Disposition: attachment;filename=computers_assets.csv');
...
// Query the database for Computer assets
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    fputcsv($output, ['No assets found in the Computer category']);
}
