...
header('Content-Disposition: attachment;filename=mobiles_assets.csv');
...
// Query the database for Mobile assets
$query = "SELECT * FROM assets WHERE ast_category = 'Mobile' AND user_id = $user_id";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    fputcsv($output, ['No assets found in the Mobile category']);
}
