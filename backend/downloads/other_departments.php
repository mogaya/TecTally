...
header('Content-Disposition: attachment;filename=other_departments_employees.csv');
...
// Query the database for Other Departments employees
$query = "SELECT * FROM employees WHERE emp_dpt = 'Other Departments'";
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    fputcsv($output, ['No employees found in the Other Departments Department']);
}
