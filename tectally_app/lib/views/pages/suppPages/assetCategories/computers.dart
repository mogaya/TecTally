...
import 'package:tectally_app/controllers/computer_controller.dart';
            ...
            content: Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // customText(
                  //   label:
                  //       "Serial No: ${computerController.computerList[index].ast_serial}",
                  //   fontSize: 20,
                  //   fontWeight: FontWeight.bold,
                  // ),
                  SizedBox(
  ...
  Future<void> getComputers() async {
    ...
    if (response.statusCode == 200) {
      ...
      var computerList = computerResponse
          .map((computer) => ComputerModel.fromJson(computer))
          .toList();
